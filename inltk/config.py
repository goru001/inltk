...
class LMConfigs:
    ...
    lm_model_file_url = {
        ...
        all_language_codes.telugu: 'https://www.dropbox.com/s/3oosy6kzoz1jd7d/export.pkl?raw=1'
    }
    tokenizer_model_file_url = {
        ...
        all_language_codes.telugu: 'https://www.dropbox.com/s/hcufsc4blm37gua/tokenizer.model?raw=1'
    }
